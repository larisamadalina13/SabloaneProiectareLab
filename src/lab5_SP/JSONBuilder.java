...
public class JSONBuilder implements Builder {
	...
	public Element buildSection(HashMap<String, Object> map) {
		...
		Collection<HashMap<String, Object>> childMap = (Collection<HashMap<String, 
				Object>>) map.get("children");
	...
	private Element processMap(HashMap<String, Object> subMap) {
		...
		// if((String)subMap.get("class") != null &&
		// ((String)subMap.get("class")).equals("Image"))
		return null;
	}
